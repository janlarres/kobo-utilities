...
The source for this plugin is available on [GitHub](https://github.com/janlarres/kobo-utilities).

A list of the changes in each release can be found in the details section of this dialog or [here](https://github.com/janlarres/kobo-utilities/blob/main/CHANGELOG.md).
